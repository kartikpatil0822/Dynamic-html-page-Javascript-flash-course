...
function menuHandler() {
    document.querySelector("#open-nav-menu").addEventListener("click", function(){
        ...
        // document.querySelector("header nav .wrapper").classList.toggle("nav-open"); -> another way to do
    });
...
function weatherHandler() {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        .then(data => {
            ...
            // Weather session under greeting
            document.querySelector(".weather-group").addEventListener("click", function(event){
                ...
                // console.log(event.target.id); // it will give the ID of that particular element
            });
        }).catch(error => {
...
function clockHandler() {
    setInterval(function(){
        ...
        // textContent and innerHTML are same and works similar
...
function populateProducts(productList) {
    ...
    productsSection.textContent = ""; // clear section before rendering next filter
